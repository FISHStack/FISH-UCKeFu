...
CREATE TABLE uk_ad_position (
  ...
  TIPclob varchar2(100) DEFAULT NULL,
...
CREATE TABLE uk_agentservice (
  ...
  conclobid varchar2(100) DEFAULT '' ,
  ...
  UPDATETIME_time date DEFAULT NULL ,
  UPDATETIME_user varchar2(255) DEFAULT NULL ,
  ...
  numberime number(32) DEFAULT NULL ,
  ...
  transmemo clob,
  agentreplynumbererval number(11) DEFAULT NULL,
  agentreplytime number(11) DEFAULT NULL,
  avgreplynumbererval number(11) DEFAULT NULL,
...
CREATE TABLE uk_callcenter_event (
  ...
  IPADDR varchar2(50) DEFAULT NULL ,
  LOCALdate varchar2(50) DEFAULT NULL ,
  STATUS varchar2(50) DEFAULT NULL ,
...
CREATE TABLE uk_callcenter_ivr (
  ...
  numbererdigittimeout number(11) DEFAULT NULL,
...
CREATE TABLE uk_chat_message (
  ...
  conclobid varchar2(50) DEFAULT NULL ,
  ...
  creater varchar2(255) DEFAULT NULL ,
  UPDATETIME decimal(20,0) DEFAULT NULL ,
  UPDATETIME_user varchar2(255) DEFAULT NULL ,
...
CREATE TABLE uk_consult_invite (
  ...
  UPDATETIME_time date DEFAULT NULL ,
  UPDATETIME_user varchar2(32) DEFAULT NULL ,
  ...
  consult_invite_numbererval number(32) DEFAULT NULL ,
...
CREATE TABLE uk_instruction (
  ...
  numbererfacetype varchar2(96) DEFAULT NULL ,
  adapter varchar2(96) DEFAULT NULL ,
  numbererfaceurl clob ,
  numbererfaceparam clob ,
...
CREATE TABLE uk_kbs_topic (
  ...
  begnumberime date DEFAULT NULL ,
  endtime date DEFAULT NULL ,
...
CREATE TABLE uk_log_request (
  ...
  opclob varchar2(255) DEFAULT NULL,
...
CREATE TABLE uk_onlineuser (
  ...
  lognumberime date DEFAULT NULL ,
...
CREATE TABLE uk_propertiesevent (
  ...
  createtime date DEFAULT NULL ,
  dataid varchar2(32) DEFAULT NULL ,
  clobvalue varchar2(255) DEFAULT NULL ,
  PRIMARY KEY (id) 
) ;
...
CREATE TABLE uk_reportmodel (
  ...
  labelclob varchar2(50) DEFAULT NULL,
  ...
  defaultvalue varchar2(50) DEFAULT NULL,
  queryclob varchar2(50) DEFAULT NULL,
...
CREATE TABLE uk_snsaccount (
  ...
  CODE varchar2(255) DEFAULT NULL ,
  USERNAME varchar2(255) DEFAULT NULL ,
  APIPOnumber varchar2(255) DEFAULT NULL ,
  PASSWORD varchar2(255) DEFAULT NULL ,
  ...
  lastatUPDATETIME varchar2(96) DEFAULT NULL ,
  lastprimsgUPDATETIME varchar2(96) DEFAULT NULL,
  ACCTYPE varchar2(32) DEFAULT NULL ,
  UPDATETIME date DEFAULT NULL ,
  creater varchar2(32) DEFAULT NULL ,
  create_time date DEFAULT NULL ,
  UPDATETIME_username varchar2(255) DEFAULT NULL ,
  UPDATETIME_time date DEFAULT NULL ,
  UPDATETIME_user varchar2(255) DEFAULT NULL ,
  shares varchar2(255) DEFAULT NULL ,
  owner varchar2(255) DEFAULT NULL ,
...
CREATE TABLE uk_systemconfig (
  ...
  mailUPDATETIMEtp varchar2(32) DEFAULT NULL,
  ...
  smsUPDATETIMEtp varchar2(32) DEFAULT NULL,
...
CREATE TABLE uk_user (
  ...
  numberegral number(11) DEFAULT NULL,
...
CREATE TABLE uk_userevent (
  ...
  creater varchar2(32) DEFAULT NULL ,
  orgi varchar2(50) DEFAULT NULL ,
  manumberype varchar2(32) DEFAULT NULL,
...
CREATE TABLE uk_worktime (
  ...
  begnumberime varchar2(20) DEFAULT NULL ,
  ...
  wbegnumberime varchar2(20) DEFAULT NULL ,
  wendtime varchar2(20) DEFAULT NULL ,
  dbegnumberime varchar2(20) DEFAULT NULL ,
...
CREATE TABLE wf_order (
  ...
  create_Time varchar2(50) NOT NULL ,
  expire_Time varchar2(50) DEFAULT NULL ,
  last_UPDATETIME_Time varchar2(50) DEFAULT NULL ,
