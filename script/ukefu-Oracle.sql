...
CREATE TABLE uk_callcenter_pbxhost (
  ...
  callbackint varchar2(50) DEFAULT NULL ,
...
CREATE TABLE uk_callcenter_siptrunk (
  ...
  outint varchar2(50) DEFAULT NULL ,
...
CREATE TABLE uk_consult_invite (
  ...
  consult_skill_ints number(11) DEFAULT NULL ,
...
CREATE TABLE uk_contacts (
  ...
  identifyint varchar2(40) DEFAULT NULL ,
...
CREATE TABLE uk_log (
  ...
  lineint varchar2(32) DEFAULT NULL,
...
CREATE TABLE uk_log_request (
  ...
  methodname clob,
  lineint varchar2(255) DEFAULT NULL,
...
CREATE TABLE uk_servicesummary (
  ...
  email varchar2(100) DEFAULT NULL ,
  phoneint varchar2(32) DEFAULT NULL ,
  summary clob ,
  agentserviceid varchar2(32) DEFAULT NULL ,
  creater varchar2(32) DEFAULT NULL ,
  createtime date DEFAULT NULL ,
...
CREATE TABLE uk_tabletask (
  ...
  UPDATETIME date DEFAULT NULL,
  UPDATETIMEint number(11) NOT NULL,
  DATASQL CLOB,
