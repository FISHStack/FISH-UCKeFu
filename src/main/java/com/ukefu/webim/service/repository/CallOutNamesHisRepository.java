...
public abstract interface CallOutNamesHisRepository extends JpaRepository<CallOutNamesHis, String> {
	...
	public abstract Page<CallOutNamesHis> findAll(Specification<CallOutTask> spec, Pageable pageable);
	...
	public abstract Page<CallOutNamesHis> findByOrgiAndDataidAndActid(String orgi , String dataid ,  String actid , Pageable page) ;
